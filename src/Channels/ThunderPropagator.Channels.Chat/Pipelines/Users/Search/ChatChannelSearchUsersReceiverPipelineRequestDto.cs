...
namespace ThunderPropagator.Channels.Chat.Pipelines.Users.Search
{
    internal
        ...
        sealed
#endif
        class ChatChannelSearchUsersReceiverPipelineRequestDto : BindingDictionary<string, object?>, IRequestContentFormCollection
    {
        public required string Term
        {
            get => (string)GetValueOrDefault(nameof(Term), string.Empty)!;
            set => this[nameof(Term)] = value;
        }
