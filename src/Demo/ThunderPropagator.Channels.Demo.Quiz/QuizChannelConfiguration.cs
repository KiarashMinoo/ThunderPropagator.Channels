...
namespace ThunderPropagator.Channels.Demo.Quiz
{
        ...
        class QuizChannelConfiguration : AbstractChannelConfiguration
    {
        ...
        /// <summary>Minimum number of connected players required before <see cref="QuizChannel.StartGame"/> allows the host to start — rejected as <see cref="QuizNotEnoughPlayersException"/> otherwise. Default: 2 (a quiz needs at least two players to be meaningfully competitive).</summary>
