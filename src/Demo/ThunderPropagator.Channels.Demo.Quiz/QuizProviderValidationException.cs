...
{
    /// <summary>
    /// Thrown by <see cref="QuizChannel.PublishAsync"/> when <see cref="QuizProviderMessage.Phase"/>
    /// requires a field the message left empty/incomplete — #194's own AC: "Invalid or incomplete
