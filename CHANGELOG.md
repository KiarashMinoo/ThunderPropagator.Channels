...
| SkiaSharp | 4.152.0 | 4.152.1 |

- Bump the testing group with 1 update `(dc9233c)` — dependabot[bot]
- Bump SkiaSharp from 4.152.0 to 4.152.1 `(f5aee73)` — dependabot[bot]
...
| NodaTime | 3.3.3 | 3.3.4 |
| SkiaSharp | 4.151.2 | 4.152.0 |

- Bump the testing group with 1 update `(a2d527d)` — dependabot[bot]
- Bump NodaTime from 3.3.3 to 3.3.4 `(40982a4)` — dependabot[bot]
- Bump SkiaSharp from 4.151.2 to 4.152.0 `(d6f8bd3)` — dependabot[bot]
...
- Implement epoch-safe host-only Video/Seek `(05b8db1)` — Kiarash Minoo
...
- Stream timestamped audio packets for synchronized client playback `(bed7ecc)` — Kiarash Minoo
- Add AAC audio encoding with configuration and source auto-detection `(4b7f533)` — Kiarash Minoo
- Restructure VideoPlayer Media by feature into Video/Audio/Session folders `(4394f6c)` — Kiarash Minoo
...
## [1.0.1-beta.86] — 2026-08-24

### 🚀 Features

- Implement the FFmpeg frame decoder and JPEG/WebP encoder `(b5b456e)` — Kiarash Minoo
